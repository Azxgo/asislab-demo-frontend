...
export default function Workers() {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            await Promise.all(
                deleteIds.map((id) =>
                    apiClient.delete(`/workers/delete/${id}`, {
                        // Importante
                        ...
                        >
                            ...
                            <div className="border border-gray-200 dark:border-zinc-600 rounded-lg">
                                <IndexPagesTable
                                    ...
                                    columns={[
                                        ...
                                        { key: "nombres", label: "Nombres", width: "1fr", hideOn: "sm", },
                                        { key: "apellido_paterno", label: "Apellido Paterno", width: "1fr", hideOn: "sm", },
                                        { key: "apellido_materno", label: "Apellido Materno", width: "1fr", hideOn: "sm", },
                                        { key: "email", label: "Email", className: "", width: "2fr", hideOn: "sm", },
                                        {
                                            key: "fechaIngreso",
                                            label: "Fecha Ingreso",
                            ...
                            {workers.length > workersPerPage && (
                                <div className="flex flex-col md:flex-row justify-between items-center gap-2 mt-4">
                                    ...
                                    {/* Paginación */}
                                    <div className="flex flex-row sm:flex-col items-center gap-2 mt-2 md:mt-0">
                                        <button
