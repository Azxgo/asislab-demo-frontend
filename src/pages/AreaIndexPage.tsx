...
export default function AreaIndexPage() {
    ...
    const fetchAreas = async () => {
        ...
        try {
            ...
            const res = await axios.get<{ areas: Area[] }>(
                "http://localhost:5000/areas/getAll",
                // Importante
                {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            for (const id of deleteIds) {
                try {
                    await axios.delete(`http://localhost:5000/areas/delete/${id}`, {
                        // Importante
                        headers: { "X-CSRF-TOKEN": csrfToken },
                        withCredentials: true,
                    });
                            ...
                            <div className="border border-gray-200 dark:border-zinc-600 rounded-lg">
                                ...
                                <IndexPagesTable
                                    ...
                                    columns={[
                                        ...
                                        { key: "num_questionnaries", label: "Cuestionarios", width: "1fr" },
                                        { key: "num_workers", label: "Trabajadores", width: "1fr" },
                                        {
