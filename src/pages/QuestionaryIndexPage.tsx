...
import { FaEllipsis, FaRegTrashCan, FaRegChartBar, FaClipboardList, FaMagnifyingGlass, FaPenToSquare } from "react-icons/fa6";
...
export default function Questionary() {
    ...
    const fetchQuestionnaires = async () => {
        ...
        try {
            ...
            const url = id
                ? `http://localhost:5000/questions/getAll?area_id=${id}`
                : `http://localhost:5000/questions/getAll`;

            const res = await axios.get<{ questionaries: Cuestionario[] }>(url, {
                // Importante
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            await Promise.all(
                deleteIds.map((id) =>
                    axios.delete(`http://localhost:5000/questions/delete/${id}`, {
                        // Importante
                        headers: { "X-CSRF-TOKEN": csrfToken },
                        withCredentials: true,
                    })
