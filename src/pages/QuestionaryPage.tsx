    ...
    useEffect(() => {
        const fetchQuestionary = async () => {
            try {
                ...
                setNumQuestions(cuestionario.num_questions ?? 5)
                setTotalQuestions(cuestionario.total_questions)
                        ...
                        >
                            ...
                            {type === "modulo" && (
                                <div className="flex flex-col">
                                    <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold mb-6">{nombre}</h1>
                                            ...
                                            return (
                                                <>
                                                    ...
                                                    >
                                                        ...
                                                        gap-2 p-2 rounded-lg transition duration-200
                                                        ${unlocked
                                                        ...
                                                        >
                                                            <div className="flex gap-2 items-center">
                                                                <h1 className="text-lg sm:text-2xl font-bold select-none">{t.nombre}</h1>
                                                            </div>
                                                            <span
                                                                className={`text-xs font-semibold px-3 py-1 rounded-full w-fit sm:w-28 flex items-center justify-center gap-2
                    ...
                    {step === "presentation" && (
                        ...
                        >
                            {type === "modulo" ? (
                                ...
                                talk ? (
                                    <>
                                        <MyPresentation slides={slidesModules?.[0]?.slides ?? []} />
                                        <button
                                            onClick={() => {
                                                setStep("questions");
                                                setStartTime(Date.now())
                            ...
                            {type === "modulo" ?
                                (
                                    <QuestionaryModulo
                                        ...
                                        questionaryId={id}
                                        guestId={guestSession ?? undefined}
                                        startTime={startTime}
                        ...
                        <div className="flex items-center justify-center min-h-[500px]">
                            ...
                            >
                                ...
                                {(() => {
                                    ...
                                    const visibleQ = mod.visible_questions ?? mod.preguntas.length
                                    const percentage = visibleQ > 0
                                        ? (scoreModule / visibleQ) * 100
                                        : 0
                                            ...
                                            <div className="w-full bg-gray-200 rounded-full h-4 mb-4">
                                                <div
                                                    className={`h-4 rounded-full 
                                                        ${scoreModule / visibleQ > 0.7
                                                            ? "bg-green-500"
                                                            : scoreModule / visibleQ >= 0.4
                                                                ? "bg-yellow-500"
                                                                : "bg-red-500"
                                                        }`}
                                                    style={{ width: `${(scoreModule / visibleQ) * 100}%` }}
                                                />
                                            </div>

                                            <div>
                                                <p className=" text-lg font-semibold">
                                                    Tu puntuación: {scoreModule} / {visibleQ}
                                                </p>
