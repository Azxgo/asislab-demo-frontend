    ...
    return (
        <>
            {questions.map((question, qIndex) => {
                const correctas = stats[question.id]?.correctas || 0
                const incorrectas = stats[question.id]?.incorrectas || 0
                                                ...
                                                {editingAlternativeIndex?.qIndex === qIndex && editingAlternativeIndex?.aIndex === aIndex ? (
                                                    <div className="flex flex-wrap md:flex-nowrap items-center gap-2 w-full">
                                                        <textarea
                                                            ...
                                                            rows={1}
                                                            autoFocus
                                                            className="border border-gray-400 rounded-md px-2 py-1 text-md outline-none text-xs sm:text-base resize-none w-full max-h-72 overflow-auto"
                                                        />
                                                        <button
                                                    ...
                                                    (
                                                        <div className="flex flex-wrap md:flex-nowrap items-center gap-2">
                                                            <h1 className="break-words text-xs sm:text-base">{alternative.texto}</h1>
                                                            <button
